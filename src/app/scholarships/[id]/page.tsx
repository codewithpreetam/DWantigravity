      ...
      <div className="glass-panel p-8 rounded-2xl border border-card-border space-y-6">
        ...
        <div className="border-t border-card-border pt-6 flex justify-between items-center">
          ...
          {user ? (
            ...
            <Link href={`/auth/signin?callbackUrl=/scholarships/${scholarship.id}`} className="px-5 py-2 bg-primary hover:bg-primary-hover text-white text-xs font-semibold rounded-lg">Login to Apply</Link>
          )}
        </div>
      </div>
    </div>
